    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 text-center">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link href="/research/portfolio" className="inline-flex items-center gap-2 px-8 py-4 bg-slate-800/60 border border-slate-700/50 text-white font-semibold rounded-xl hover:bg-slate-800 hover:border-brand-500/40 transition-all">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
